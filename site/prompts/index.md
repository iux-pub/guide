...
인포마인드 UX팀 디자인 시스템 규칙을 AI 도구에 적용하기 위한 프롬프트 모음이다. 각 프롬프트는 AI 도구 유형별로 최적화되어 있으며, 복사하여 바로 사용할 수 있다.

## 사용법

아래 프롬프트를 복사하여 AI 도구의 시스템 프롬프트나 첫 메시지에 붙여넣으세요.
...
| 코드 리뷰 | [코드 리뷰 체크리스트](/prompts/review/) | 모든 AI (리뷰 용도) |
...
- **코드 리뷰:** 코드 리뷰 체크리스트로 팀 규칙 기반 자동 리뷰를 요청한다
