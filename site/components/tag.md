...
KRDS 정의 컴포넌트. 권위 있는 소스는 `src/snippets/tag.md`이며, BEM·접근성·토큰 매핑 카탈로그는 [references/krds-components.md](https://github.com/iux-pub/guide/blob/main/references/krds-components.md#tag)에 있다.
...
- 카탈로그: [krds-components.md#tag](https://github.com/iux-pub/guide/blob/main/references/krds-components.md#tag)
